...
class ScribeService {
  ...
  public interface Iface {
    ...
    public void Log2(List<LogEntry> messages) throws TException;
  ...
  public interface AsyncIface {
    ...
    public void Log2(List<LogEntry> messages, AsyncMethodCallback<AsyncClient.Log2_call> resultHandler) throws TException;
  ...
  public static class Client extends TServiceClient implements Iface {
    ...
    public void send_Log2(List<LogEntry> messages) throws TException
    {
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    @Override
    public void Log2(List<LogEntry> messages, AsyncMethodCallback<Log2_call> resultHandler) throws TException {
      checkReady();
    ...
    public static class Log2_call extends TAsyncMethodCall {
      private List<LogEntry> messages;
      public Log2_call(List<LogEntry> messages, AsyncMethodCallback<Log2_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.messages = new ArrayList<LogEntry>(_list8.size);
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.messages != null) {
        oprot.writeFieldBegin(MESSAGES_FIELD_DESC);
        {
          ...
          for (LogEntry _iter11 : this.messages)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  public static class Log2_args implements TBase<Log2_args, Log2_args._Fields>, java.io.Serializable, Cloneable   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.messages = new ArrayList<LogEntry>(_list12.size);
                for (int _i13 = 0; _i13 < _list12.size; ++_i13)
                {
                  LogEntry _elem14;
                  _elem14 = new LogEntry();
                  _elem14.read(iprot);
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.messages != null) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.messages.size()));
          for (LogEntry _iter15 : this.messages)
          {
            _iter15.write(oprot);
          }
          oprot.writeListEnd();

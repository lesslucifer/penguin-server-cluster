 ...
 */
public class ScUpgradeBoxEgg extends ScBase{
            ...
            try {
                action.loadGame(uid, sessions, 
                    (Responder resp) -> 
                    {
                        ...
                        {
                            try { 
                                action.upgradeBoxEgg(uid, last_cote, sessions, (Responder resp1) -> {
                                    checkCompleteScenario(uid);});
    ...
    public static void main(String[] args)
    {
        ...
        PGLogCalculator.getInst().setScenario("upgrade_boxegg");
        for(int i = 0; i < nTest; ++i)
        {
            ScUpgradeBoxEgg loader = new ScUpgradeBoxEgg();
            try {
